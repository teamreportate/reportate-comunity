...
public interface Constants {
    ...
    interface Parameters{
        ...
        String CANTIDAD_MAXIMA_CONTROL = "CANTIDAD_MAXIMA_CONTROL";
        String MENSAJE_CANTIDAD_MAXIMA_REGISTRO= "MENSAJE_CANTIDAD_MAXIMA_REGISTRO";

        String JWT_TIEMPO_VALIDES_BACKEND = "JWT_TIEMPO_VALIDES_BACKEND";
        String JWT_TIEMPO_VALIDES_FRONTEND = "JWT_TIEMPO_VALIDES_FRONTEND";
        String JWT_LLAVE_PRIVADA = "JWT_LLAVE_PRIVADA";

        String CANTIDAD_INTENTO_AUTENTICACION = "CANTIDAD_INTENTO_AUTENTICACION";
